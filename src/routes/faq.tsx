...
const itemTitle = { fontFamily: serif, fontSize: 19, fontWeight: 600, marginBottom: 8 } as const;
...
function FaqPage() {
  ...
  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '40px 28px 80px', animation: 'tpFade 0.35s ease' }}>
      ...
      <h1 style={{ fontFamily: serif, fontWeight: 500, fontSize: 42, letterSpacing: '-0.015em', margin: '0 0 10px' }}>Questions, honestly answered.</h1>
      ...
      <div style={{ textAlign: 'center', marginTop: 40, padding: 28, background: '#FCFAF5', border: '1px dashed #DAD1BD', borderRadius: 14 }}>
        <div style={{ fontFamily: serif, fontSize: 22, marginBottom: 6 }}>Still stuck?</div>
